...
app.get("/", async (req, res) => {
  ...
  write(`<body>`);
  write(
    `<h1>showincamera <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`
  );
  write(
    `<p>This library is available as JavaScript UMD module: <a href='/parsegraph-showincamera.js'>parsegraph-showincamera.js</a></p>`
  );
